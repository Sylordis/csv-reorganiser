 ...
 *
 */
@ChessOperation(name = "value")
@ChessOperationProperty(name = "value", field = "value", required = true, description = "Constant value to output")
@ChessOperationShortcut(keyword = "value", property = "value")
