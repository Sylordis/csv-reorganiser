...
class ConfigurationExceptionTest {
	...
	/**
	 * Test method for {@link com.sylordis.tools.csv.reorganiser.model.exceptions.ConfigurationException#ConfigurationException(java.lang.String, java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.ConfigurationException#ConfigurationException(java.lang.String, java.lang.Throwable)}
	 * when providing a null cause or message.
	 */
	@Test
	@Tag("Constructor")
	void testConfigurationExceptionStringThrowableNull() {
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.ConfigurationException#ConfigurationException(java.lang.String)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testConfigurationExceptionStringNull() {
		final String message = null;
		ConfigurationException ex = new ConfigurationException(message);
		assertNotNull(ex, "Newly created exception should not be null");
		assertEquals(message, ex.getMessage(), "Same message should be returned");
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.ConfigurationException#ConfigurationException(java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testConfigurationExceptionThrowableNull() {
		Throwable t = null;
		ConfigurationException ex = new ConfigurationException(t);
		assertNotNull(ex, "Newly created exception should not be null");
		assertSame(t, ex.getCause(), "Same cause should be returned when asked");
