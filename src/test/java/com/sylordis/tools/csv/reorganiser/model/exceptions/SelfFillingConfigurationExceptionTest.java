...
class SelfFillingSelfFillingConfigurationExceptionTest {
	...
	/**
	 * Test method for {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingConfigurationException#SelfFillingConfigurationException(java.lang.String, java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingConfigurationException#SelfFillingConfigurationException(java.lang.String, java.lang.Throwable)}
	 * when providing a null cause or message.
	 */
	@Test
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingConfigurationExceptionStringThrowableNull() {
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingConfigurationException#SelfFillingConfigurationException(java.lang.String)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingConfigurationExceptionStringNull() {
		final String message = null;
		SelfFillingConfigurationException ex = new SelfFillingConfigurationException(message);
		assertNotNull(ex, "Newly created exception should not be null");
		assertEquals(message, ex.getMessage(), "Same message should be returned");
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingConfigurationException#SelfFillingConfigurationException(java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingConfigurationExceptionThrowableNull() {
		Throwable t = null;
		SelfFillingConfigurationException ex = new SelfFillingConfigurationException(t);
		assertNotNull(ex, "Newly created exception should not be null");
		assertSame(t, ex.getCause(), "Same cause should be returned when asked");
