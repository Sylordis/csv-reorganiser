...
class SelfFillingExceptionTest {
	...
	/**
	 * Test method for {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingException#SelfFillingException(java.lang.String, java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingException#SelfFillingException(java.lang.String, java.lang.Throwable)}
	 * when providing a null cause or message.
	 */
	@Test
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingExceptionStringThrowableNull() {
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingException#SelfFillingException(java.lang.String)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingExceptionStringNull() {
		final String message = null;
		SelfFillingException ex = new SelfFillingException(message);
		assertNotNull(ex, "Newly created exception should not be null");
		assertEquals(message, ex.getMessage(), "Same message should be returned");
	...
	/**
	 * Test method for
	 * {@link com.sylordis.tools.csv.reorganiser.model.exceptions.SelfFillingException#SelfFillingException(java.lang.Throwable)}.
	 */
	@Test
	@Tag("Constructor")
	...
	@Tag("Constructor")
	@Tag("Null")
	void testSelfFillingExceptionThrowableNull() {
		Throwable t = null;
		SelfFillingException ex = new SelfFillingException(t);
		assertNotNull(ex, "Newly created exception should not be null");
		assertSame(t, ex.getCause(), "Same cause should be returned when asked");
